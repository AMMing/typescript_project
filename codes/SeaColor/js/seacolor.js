...
(function () {
    var path = '/template/SeaColor';
    var debug_path = 'http://ts.amoe.me/seacolor';
    var now_url = window.location.href.toLowerCase();
    var is_debug = now_url.indexOf('debug=ture') > 0; //手动进入调试页面
    AMing.Core.Helper.append_js((is_debug ? debug_path : path) + "/js/append.js", function () { return (new SeaColor.Append(path)).init(); });
})();
